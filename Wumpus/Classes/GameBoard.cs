            ...
            switch (Level)
            {
                case 1:
                    Matrix = new int[,] {
                        ...
                        { 10,10,10,10,10,10,01,10,10,00,10,10,10,00,00,10,10,10,00,10,10,01,10,10,10,10,10,10 },
                        { 10,00,00,00,00,00,01,00,00,00,10,10,10,00,00,10,10,10,00,00,00,01,00,00,00,00,00,10 },
                    ...
                    break;
                case 2:
                    Matrix = new int[,] {{ 10, 10, 10, 10, 10, 10},
                                         { 10, 0, 0, 0, 0, 10},
                                         { 10, 0, 0, 0, 0, 10},
                                         { 10, 0, 0, 0, 0, 10},
                                         { 10, 03, 0, 0, 0, 10},
